...
#
  def add_or_remove_cash(pet_shop, money)
    ...
    #   new_total_cash = pet_shop[:admin][:total_cash] += money
    # end
     # as above - function commented-out as the previous function covers both tests.
...
#     # tests returns level of stock value
...
#
  ...
  # def test_add_pet_to_stock(pet_shop, new_pet)
  ...
  # end
   ...
   # test checks function returns correct pet count value
